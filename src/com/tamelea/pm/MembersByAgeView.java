...
public final class MembersByAgeView extends View {
	private View							membersView;
	private JMenuBar						menuBar;
	
	public MembersByAgeView(
			Data data, 
			PeriMeleonView membersView, 
			String sortFieldName, 
			MemberAgeFilter filter) 
	{
		super("");
		this.data = data;
		...
		setTitle("Members whose age is " + filter.getComparisonOp().toString() + " " + filter.getAge() +
				" years as of " + filter.getDate().toString());
		table = new PMTable();
		tableModel = new MembersByAgeTableModel(table, data, sortFieldName, filter);
