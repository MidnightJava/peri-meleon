...
import com.tamelea.pm.data.StatisticalTransactionsTableModel;

@SuppressWarnings("serial")
public final class StatisticalView extends View {
	private StatisticalTransactionsTableModel			tableModel;
	private PMTable						table;
	private PeriMeleonView				membersView;
	private JMenuBar					menuBar;
	
	public StatisticalView(Data data, PeriMeleonView membersView, PMDate earliest, PMDate latest) {
		super("Statistical Transactions");
		this.membersView = membersView;
		this.setIconImage(Toolkit.getDefaultToolkit().createImage(
				com.tamelea.pm.PeriMeleonView.class.getResource("icon16.gif")));
		enableEvents(AWTEvent.WINDOW_EVENT_MASK);
		setTitle("Transactions From " + earliest + " to " + latest + " Inclusive");
		tableModel = new StatisticalTransactionsTableModel(data, earliest, latest);
	...
	private final class CopyAction extends AbstractAction {
		public static final String key = "copyTransactions";
