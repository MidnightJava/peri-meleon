...
final class AddTransactionDialog extends JDialog {
	...
	AddTransactionDialog(View view, Data data, MemberIndex member) {
		super(view, "Add Transaction", true);
			...
			if (field.editable) {
				...
				try {
					...
					throw new IllegalStateException(
							"AddTransactionDialog ctor: can't instantiate editor for "
							+ field, e);
				}
...
//					System.out.println(field.toString() + ": " + datum);
				...
				//index was set when Transaction constructed
