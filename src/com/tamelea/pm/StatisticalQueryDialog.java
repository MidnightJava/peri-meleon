...
public class StatisticalQueryDialog extends JDialog
	implements ActionListener
{
	...
	public StatisticalQueryDialog(Data data, PeriMeleonView view) {
		super(view, "Transactions For Statistics", true);
		...
		mainPane.add(new JLabel("Transactions between these inclusive dates:"), BorderLayout.NORTH);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equals("execute")){
			...
			setVisible(false);
			membersView.launchView(StatisticalView.class, data, membersView, earliest, latest);
