...
final class EditServiceDialog extends JDialog {
	...
	EditServiceDialog(View view, Data data, MemberIndex member, Service service) {
		super(view, "Edit Service", true);
		...
		for (ServiceField field : ServiceField.values()) {
			if (field.editable) {
				...
				Object storedValue = service.getValue(field);
				try {
					...
					throw new IllegalStateException(
							"EditServiceDialog ctor: can't instantiate editor for "
							+ field, e);
				}
