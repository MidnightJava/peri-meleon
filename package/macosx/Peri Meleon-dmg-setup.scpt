tell application "Finder"
  tell disk "Peri Meleon"
    ...
    set the bounds of container window to {400, 100, 917, 470}
    ...
    repeat with theFile in allTheFiles
      ...
      if theFilePath is "/Peri Meleon.app"
        -- Position application location
        set position of item theFile of container window to {120, 80}
      else if theFilePath is "/Applications"
        -- Position install location
        set position of item theFile of container window to {390, 80}
      else
